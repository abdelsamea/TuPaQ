...
% the centroid and the axis of minimum inertia.
 ...
 function [FV] = momentALI(im,flage)
%im=imread(filename); 
im=double(im);
%scale = .5;
...
%     hold;
  ...
  figure(11),
    ...
    figure(12),
    [r lag]=xcorr(E_distanceData1(:),(E_distanceData2(:)));
    plot(lag,r,'g.-')
%%
 ...
 a=[xcorr((E_distanceData1),(E_distanceData2),0,'coeff') xcorr((E_distanceData1),flipud(E_distanceData2),0,'coeff')];
