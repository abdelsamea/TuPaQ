...
%  [f4,x1]=ksdensity(E_distanceDataC2);
   %  FV=[abs(mean(E_distanceData1(:))- mean(E_distanceData2(:))) abs( mean(E_distanceDataC1(:)) - mean(E_distanceDataC2(:)))];   
